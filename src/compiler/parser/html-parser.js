...
export function parseHTML (html, options) {
  ...
  while (html) {
    ...
    if (!lastTag || !isPlainTextElement(lastTag)) {
      ...
      if (textEnd === 0) {
        ...
        // 正式处理开始标签
        //  比如：<div id="app">，得到：startTagMatch = { tagName: 'div', attrs: [[xx], ...], start: index }
  ...
  function handleStartTag (match) {
     ...
     *
     *  这里的start方法原型在 src/compiler/parser/index.js 237行左右
     */
    if (options.start) {
